...
<table>
  ...
  <tr align="left">
    ...
    <td>
      <b>- 분기별 데이터 분석 및 시각화</b>
    </td>
    <td>
      <b>- 장르별 데이터 분석 및 시각화</b>
    </td>
  </tr>
</table>
...
## 기획의도
대형 배급사 중심의 과점 구조와 시장 침체 상황에서 자본력이 흥행의 기준인가에 대한 문제를 제기하여 제한된 자원을 가진 신생 배급사가 관객 동원력을 극대화할 수 있는 데이터를 기반으로 전략을 도출한다.
## 기대효과
...
### 🗄 Database
- 데이터셋명: KOBIS 박스오피스 영화정보  
- 제공 기관: 문화체육관광부 · 문화 빅데이터 플랫폼  
- 데이터 출처 링크: https://www.bigdata-culture.kr/bigdata/user/data_market/detail.do?id=9d00dd80-4a54-11eb-af9a-4b03f0a582d6#
